...
import failSvg from '@/public/assets/svg/payment-fail.svg';
		...
		<>
			...
			<section className='px-8 py-14 grid grid-cols-1 items-center justify-items-stretch lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 '>
				<article className='me-10'>
					<h1 className='mb-5 font-bold text-3xl'>{t('Payment Error')}</h1>
				...
				<img src={failSvg.src} alt='Fail' className=' h-[380px]' />
			</section>
		</>
	);
};
